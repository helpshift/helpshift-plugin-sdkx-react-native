...
import {updateMasterAttributes} from "helpshift-plugin-sdkx-react-native";
...
const MasterAttributes = () => {
  ...
  const updateAttributes = () => {
    updateMasterAttributes({...attributes});
  };
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.title}>MASTER ATTRIBUTES</Text>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.appButtonText}>Update Master Attributes</Text>
      </TouchableOpacity>

      <TouchableOpacity
        style={[styles.secondaryButtonContainer, styles.mt]}
        onPress={() => resetAttributes()}>
        <Text style={styles.secondaryButtonText}>Reset Master Attributes</Text>
      </TouchableOpacity>
      <View style={styles.separator} />

      <Text style={styles.title}>Master Attributes Preview</Text>
